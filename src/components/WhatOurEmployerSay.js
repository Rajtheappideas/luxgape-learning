  ...
  return (
    <div className="my-20" id="testimonial">
      ...
      <div className="flex items-center justify-center space-x-10 w-full">
        {/* --------------------------left div--------------------------- */}
        <div className="p-10 overflow-x-hidden border w-[663px] h-[246px] rounded-tl-[0px] rounded-br-[85px] rounded-tr-none rounded-bl-none bg-white ">
        ...
        <div className="relative p-10 shadow-lg border min-w-[663px] max-h-[246px] rounded-tl-[85px] rounded-br-[85px] rounded-tr-none rounded-bl-none bg-white ">
          ...
          <div className="flex items-center mb-10">
            <img src={img} alt="img" className="rounded-full object-center object-cover w-16 h-16 bg-gray-400"></img>
        ...
        <div className="p-10 border w-[663px] h-[246px] rounded-tl-[85px] rounded-br-none rounded-tr-none rounded-bl-none bg-white ">
          ...
          <p className="text-xl leading-snug tracking-wide font-medium w-full overflow-x-hidden">
            “The course is easy to understand and the mentor is cool, making my
            learning experience here very enjoyable”
          </p> */}
        </div>
