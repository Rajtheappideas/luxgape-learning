...
const Herosection = () => {
  return (
    <div className="sm:p-10 p-5 grid gap-10 lg:grid-cols-2 grid-flow-row grid-cols-1 place-items-center items-center h-full w-full">
      ...
      <div className="w-full relative h-full lg:text-left text-center space-y-14">
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 items-center lg:justify-start justify-center sm:space-x-12 w-full">
          <img
            className="object-contain object-center sm:h-28 h-36"
            src={simg3}
            alt="studyimg"
          />
          <img
