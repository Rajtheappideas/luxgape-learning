...
const Herosection = () => {
  return (
    <div className="p-10 grid gap-2 lg:grid-cols-2 lg:grid-rows-1 grid-cols-1 grid-rows-2 mt-5 mb-16 h-full w-full">
      {/* ------------text and search is here------------------------------ */}
      <div className="w-full relative h-full mt-20 mb-5 space-y-16">
        {/* -------------------------------------text--------------------------------     */}

        <div className="text-6xl tracking-normal font-bold text-black">
          <div className="mb-10">
            <span className="mb-10 block">Learning And</span>
...
bg-gradient-to-l from-[#33bac6] to-[#162765]"
        ...
        <div className="">
          ...
          />
          {/* --------search button----------- */}
          <button className="absolute lg:right-24 md:right-48 sm:right-32 right-16 h-[72px] w-[72px] bg-primary rounded-tl-[36px] rounded-br-[36px] rounded-tr-none rounded-bl-none ">
