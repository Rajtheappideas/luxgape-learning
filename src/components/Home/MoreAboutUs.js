...
const MoreAboutUs = () => {
  ...
  return (
    <div className="relative lg:p-10 p-3 w-full h-full bg-black sm:rounded-tl-[285px] sm:rounded-br-[285px] rounded-tr-none rounded-bl-none">
      <div className="text-white sm:p-6 grid lg:grid-cols-2 grid-flow-row sm:grid-cols-1 place-items-center gap-10 items-center">
        {/* ------------------text is here---------------- */}
        <div className="w-full sm:space-y-6 space-y-3 sm:py-5 lg:text-left text-center">
          ...
          <p className="sm:text-2xl text-xl w-full leading-normal sm:text-left text-center tracking-normal sm:mb-7">
